...
<table>
  <tr>
    ...
    <!--<th class="cate_one">Stock Out</th>-->
  ...
  <tr>
    ...
    <td><?php if($result['model_number']) echo $result['model_number'];?></td>
        <!--<td><?php //if($result['stock_out']) echo $result['stock_out'];?></td>-->
...
<div class="center_one"><a href="<?= base_url() ?>product/stock_out_list"><button type="button" class="new_button" >Back to Main Menu</button></a></div>
