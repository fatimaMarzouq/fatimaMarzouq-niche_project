...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/training_tracker_list/">
          ...
          <table class="table table-striped table-bordered" id="table_list">
            ...
            if(!empty($result)){
                    ...
                    foreach($result[0] as $k => $r){
                        if($k != 'outlet_name' && $k != 'region' && $k != 'date' &&  $k != 'id'  && $k != 'images'){
    ...
    <!--<th class="cate_one">Sub Category</th>-->
    <th class="cate_one">Brand</th>
    <th class="cate_one">Model Number</th>
        <th class="cate_one">Promoter Type</th>
        <th class="cate_one">Promoter Name</th>
    ';
                                    } 
                                }
                            }
            ...
            <tr class="custom-tr">
              <td><a href="<?= base_url(); ?>product/training_tracker_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            ...
            if(!empty($row)){
                    ...
                    foreach($row as $k => $r){
                      //  echo $r.'</br>';
                        ...
                        if($k != 'outlet_name' && $k != 'region' && $k != 'date' &&  $k != 'id'){
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                echo '<td>'.$r.' </td>';
                            }else{
...
//echo $add_more_array[0];
                                    for ($x = 0; $x < $total_count; $x++) {
                                        ...
                                        <td><?php if($result['promoter_type']) echo $result['promoter_type'];?></td>
                                        <td><?php if($result['promoter_name']) echo $result['promoter_name'];?></td>
    ...
    <?php
            ...
            <form id="filter_status_id" action="<?= base_url() ?>product/training_tracker_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/training_tracker_list">
