...
<table>
  <tr>
    <th class="cate_one">Entrance</th>
    <th class="cate_one">Home Appliance Area</th>
    <th class="cate_one">New Oppurtunity Area</th>
    <th class="cate_one">Fixture</th>
    <th class="cate_one">Others</th>
   
  </tr>
  

   <?php
   if($result['add_more_array']){
    ...
    //  echo '<pre>';print_r($add_more_array);
        foreach($add_more_array as $resultm){
            ...
            ?>
  <tr>
    <td><?php if($result1[0]['entrance_images']){
        ...
        foreach($entrance_images as $resul){
            //echo $resul;
            ?>
        <a href="<?php if($resul) echo $resul;?>" target="_blank">
        <img src="<?php if($resul) echo $resul;?>" height="90" width="90" style="margin-left:5px;"/></a>
        <?php }} ?>
    </td>
   <td><?php if($result1[0]['appliance_images']){
    ...
    <td><?php if($result1[0]['oppurtunity_images']){
    ...
    <td><?php if($result1[0]['fixture_images']){
        ...
        <td><?php if($result1[0]['other_images']){
...
<div class="center_one"><a href="<?= base_url() ?>product/images_list"><button type="button" class="new_button" >Back to Main Menu</button></a></div>
