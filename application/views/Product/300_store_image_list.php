        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/store_image_list/">
          ...
          <table class="table table-striped table-bordered" id="table_list">
            ...
            <tr class="custom-tr">
              <td><a href="<?= base_url(); ?>product/store_image_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            ...
            <form id="filter_status_id" action="<?= base_url() ?>product/store_image_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/store_image_list">
