...
<!--                    </form>-->
        ...
        <div class="x_content">
          <div class="grid-body ">
           ...
           <?php
$output = '';
$output .= form_open_multipart('product/import_save');
          ...
          <table id="datatable3333333" class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <td><?=$value['model_number']?></td>
                 ...
                 <td>
                 <a href="<?=base_url('product/edit_product/'.$id)?>">
                    <button type="button" class="btn btn-primary">Edit</button>
                  </a>

                   
               
                <a href="<?=base_url('product/delete_master1/'.$id)?> " onclick="return confirm('are you sure want to delete')">
