...
<div class="center_one"><a href="<?= base_url() ?>product/training_tracker_list"><button type="button" class="new_button" >Back to Main Menu</button></a></div>
