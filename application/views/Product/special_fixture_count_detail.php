   ...
   // echo $result['images'];
    if($result['images']){
        ...
        foreach($images as $resul){
            //echo $resul;
           $resul = str_replace("http://162.144.65.120/~procopbn/nichefas/","http://phpstack-677734-2428744.cloudwaysapps.com/",$resul);
            ?>
...
<div class="center_one"><a href="<?= base_url() ?>product/special_fixture_count_list"><button type="button" class="new_button" >Back to Main Menu</button></a></div>
