        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/display_by_model_count_list/">
          ...
          <table class="table table-striped table-bordered" id="table_list">
            <thead class="thead-dark">
              ...
              $sort_item = (empty($_GET['sort']) ? 'id' : $_GET['sort']);$sort_type = (empty($_GET['by']) ? "desc" : $_GET['by']); ?>
               <tr>
                 <th>Action</th>
                  <th class="sortable" id="outlet_name">Outlet Name 
                  <!--<span>-->
                  ...
                  <th class="sortable" id="region">Region 
                  <!--<span>-->
                  ...
                  <th class="sortable" id="name">Name
                  <!--<span>-->
                     <!-- <i class="fas fa-sort-up <?= ($sort_item == 'name') ? ($sort_type == "desc" ? "text-muted" : "") : "" ?>"></i>
                  <!--   <i class="fas fa-sort-down <?= ($sort_item == 'name') ? ($sort_type == "asc" ? "text-muted" : "") : "" ?>"></i> -->
                  <!--   </span>-->
                     </th>
                      <?php 
            if(!empty($result)){
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $max_count; $x++) {
                                     echo  '<th class="cate_one">Category</th>
    <th class="cate_one">Brand</th>
    <th class="cate_one">Model Number</th>
    <th class="cate_one">Display type</th>
...
';
            ...
            <tr class="custom-tr">
              <td><a href="<?= base_url(); ?>product/display_by_model_count_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $total_count; $x++) {
                                        ...
                                        <td><?php if($result['display_type']) echo $result['display_type'];?></td>
    ...
    <?php
            ...
            <form id="filter_status_id" action="<?= base_url() ?>product/display_by_model_count_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/display_by_model_count_list">
