...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/price_tracker_list/">
    ...
    <th class="cate_one">Segment</th>
    <th class="cate_one">Model Number</th>
        <th class="cate_one">RRP(AED)</th>
        <th class="cate_one">OFFER PRICE(AED)</th>';
                                    } 
                                }
                            }
                        }
            ...
            <tr class="custom-tr">
              <td><a href="<?= base_url(); ?>product/price_tracker_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
    ...
    <td><?php if($result['segment']) echo $result['segment'];?></td>
        <td><?php if($result['model_number']) echo $result['model_number'];?></td>
    <td><?php if($result['rrp']) echo $result['rrp'];?></td>
    <td><?php if($result['rrp']) echo $result['offer_price'];?></td>
    ...
    <?php
            ...
            <form id="filter_status_id" action="<?= base_url() ?>product/price_tracker_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/price_tracker_list">
