...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/voc_list/">
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $max_count; $x++) {
                                     echo  '<th class="cate_one">VOC Type</th>
    <th class="cate_one">Comments</th>
    ';
                                    } 
                                }
                            }
            ...
            <tr class="custom-tr">
              <td><a href="<?= base_url(); ?>product/voc_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $total_count; $x++) {
                                        ...
                                        <td><?php if($result['voc']) echo $result['voc'];?></td>
                                        <td><?php if($result['comment']) echo $result['comment'];?></td>
    ...
    <?php
            ...
            <form id="filter_status_id" action="<?= base_url() ?>product/voc_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/voc_list">
