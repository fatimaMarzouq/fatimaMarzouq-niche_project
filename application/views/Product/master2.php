...
<!--                    </form>-->
        ...
        <div class="x_content">
          <div class="grid-body ">
           ...
           <?php
$output = '';
$output .= form_open_multipart('product/import_master2_save');
...
?>
          <table id="datatable3333333" class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <td><?=$value['fixture_type']?></td>
                
                <td><?=$value['activity_type']?></td>
                <td><?=$value['voc_type']?></td>
                <td><?=$value['promoter_type']?></td>
                <td><?=$value['condition_fixture']?></td>
                 <td>
                 <a href="<?=base_url('product/edit_master2/'.$id)?>">
                    <button type="button" class="btn btn-primary">Edit</button>
                  </a>

                   
               
                <a href="<?=base_url('product/delete_master2/'.$id)?> " onclick="return confirm('are you sure want to delete')">
