  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="<?=base_url('welcome/save_customer')?>">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="email" placeholder="Enter Username" required="required">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select class="form-control" name="role" onchange="show_data(this.value)" required="required">

                <option style="font-size:10pt" value="">Select Role</option>
             <?php foreach ($roles as $key => $value1) {?>
                <option value="<?=$value1['id'];?>"><?=$value1['role'];?></option>
                           <?php } ?>         
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="row">
                ...
                <?php foreach ($outlet_list as $key => $value1) {?>
                <!--<option value="<?=$value1['id'];?>"><?=$value1['outlet_name'];?></option>-->
                <div class="col-sm-4">
                 <div class="form-group1">
                  <input type="checkbox" name="assigned_outlet[]" id="<?=$value1['id'];?>" value="<?=$value1['id'];?>">
          ...
          <div class="form-group" style="margin-top:20px;">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <!-- <option style="font-size:10pt" value="">Select Form</option>-->
               <div class="row" >
             <?php foreach ($forms_name as $key => $value1) {?>
                <!--<option value="<?=$value1;?>"><?=$value1;?></option>-->
                <div class="col-sm-6">
                 <div class="form-group1">
                  <input type="checkbox" id="<?=$value1;?>" name="assigned_form[]" value="<?=$value1;?>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text"  name="target" placeholder="Enter Target" >
            </div>
          </div>
          </div>
