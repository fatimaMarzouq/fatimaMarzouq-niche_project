...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/market_issues_list/">
    ...
    <th class="cate_one">No Display Model</th>
    <th class="cate_one">New Fixture OPP</th>
        <th class="cate_one">New Branding OPP</th>
    ';
                                    } 
                                }
                            }
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $total_count; $x++) {
                                        ...
                                        <td><?php if($result['no_display_model']) echo $result['no_display_model'];?></td>
                                         <td><?php if($result['new_fixture_opp']) echo $result['new_fixture_opp'];?></td>
                                          <td><?php if($result['new_branding_opp']) echo $result['new_branding_opp'];?></td>
    ...
    <?php
                    ...
                    ?>
               <td><a href="<?= base_url(); ?>product/market_issues_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            </tr>
             <tr class="hidden">
               <td class="py-1 border-0"></td>
            </tr>
            <form id="filter_status_id" action="<?= base_url() ?>product/market_issues_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/market_issues_list">
