...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/brand_promoter_count_list/">
            ...
            if(!empty($result)){
             //  echo '<pre>';print_r($result);
                    foreach($result[0] as $k => $r){
                        if($k != 'outlet_name' && $k != 'region' && $k != 'date' &&  $k != 'image_array'){
    ...
    <th class="cate_one">Distributor(Shared)</th>
    <th class="cate_one">Dedicated Brand</th>
    <th class="cate_one">MDA</th>
        <th class="cate_one">SDA</th> ';
                                    } 
                                }
                            }
                        }
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $total_count; $x++) {
                                        ...
                                        <td><?php if($result['distributor']) echo $result['distributor'];?></td>
    <td><?php if($result['dedicated_brand']) echo $result['dedicated_brand'];?></td>
        <td><?php if($result['mda']) echo $result['mda'];?></td>
    <td><?php if($result['sda']) echo $result['sda'];?></td>
    ...
    <?php
                    ...
                    ?>
               <td><a href="<?= base_url(); ?>product/brand_promoter_count_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            </tr>
             <tr class="hidden">
               <td class="py-1 border-0"></td>
            </tr>
            <form id="filter_status_id" action="<?= base_url() ?>product/brand_promoter_count_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/brand_promoter_count_list">
