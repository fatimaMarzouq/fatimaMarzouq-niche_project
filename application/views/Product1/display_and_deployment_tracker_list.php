...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/display_and_deployment_tracker_list/">
          ...
          <table class="table table-striped table-bordered" id="table_list">
            ...
            if(!empty($result)){
                    ...
                    foreach($result[0] as $k => $r){
                        if($k != 'outlet_name' && $k != 'region' && $k != 'name' &&  $k != 'id'  && $k != 'images_posm_before' && $k != 'images_posm_after'){
    ...
    <?php
                    ...
                    ?>
               <td><a href="<?= base_url(); ?>product/display_and_deployment_tracker_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            </tr>
             <tr class="hidden">
               <td class="py-1 border-0"></td>
            </tr>
            <form id="filter_status_id" action="<?= base_url() ?>product/display_and_deployment_tracker_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/display_and_deployment_tracker_list">
