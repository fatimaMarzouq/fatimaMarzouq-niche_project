...
<div class="right_col" role="main">
  <div class="row">
        ...
        <div class="x_content">
          <div class="grid-body ">
            <div class="col-sm-12" style="margin-bottom:7px;">
                ...
                <form class="d-flex justify-content-center" method="get" name ="filter_status_id" id="filter_status_id" action="<?= base_url() ?>product/display_share_list/">
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $max_count; $x++) {
                                     echo  ' <th class="cate_one">Segment</th><th class="cate_one">Category</th>
    <th class="cate_one">Brand</th>
    <th class="cate_one">Number of Display</th>
    <th class="cate_one">Total Number of Display</th> ';
                                    } 
                                }
                            }
                        }
                            ...
                            if($k != 'add_more_array' && $k != 'add_more_array_count'){
                                ...
                                if($k == 'add_more_array_count'){
                                    ...
                                    for ($x = 0; $x < $total_count; $x++) {
                                         ...
                                         ?>
                                         <td><?php if($result['segment']) echo $result['segment'];?></td>
                                                                         <td><?php if($result['category']) echo $result['category'];?></td>
                                        <td><?php if($result['brand']) echo $result['brand'];?></td>
                                        <td><?php if($result['number_of_display']) echo $result['number_of_display'];?></td>
                                         <!--<td><?php// if($result['stock']) echo $result['stock'];?></td>-->
                                        <td><?php if($result['total_number_of_display']) echo $result['total_number_of_display'];?></td>
    ...
    <?php
               ...
               <td><a href="<?= base_url(); ?>product/display_share_detail/<?=$row['id']?>"  class="btn btn-sm btn-primary text-white">Detail</a></td>
            </tr>
             <tr class="hidden">
               <td class="py-1 border-0"></td>
            </tr>
            <form id="filter_status_id" action="<?= base_url() ?>product/display_share_list/"></form>
...
<?php $from_date =  isset($_GET['from_date']) ? $_GET['from_date'] : "";
                ...
                ?>
<form method="post" id="export_table" action="<?= base_url() ?>product/display_share_list">
